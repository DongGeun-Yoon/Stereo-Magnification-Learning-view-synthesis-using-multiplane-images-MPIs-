...
parser.add_argument('--img_size', default=img_size, type=tuple, help="training data image resolution")
...
if __name__ == '__main__':
    ...
    # Custom dataloaders
    valid_dataset = RealEstateDataset(data_dir, img_size=img_size, is_valid=True, num_planes=num_planes)
